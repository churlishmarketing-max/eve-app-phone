...
## DAILY WORKFLOW
1. Pull the active ICP — brand-side (Authority Spark lanes) or service-side ([NEEDS: service-side ICP — the Crucible avatars retired to Kelly Bromley on Sept 21; Brandon names the replacement]), depending on which track is live.
