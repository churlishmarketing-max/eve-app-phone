...
**Authority Lite is retired** — never scope new work at it. Two legacy accounts bill at their grandfathered rate per their contract. New line items:
- **Guest Authority Package — $2,500 PIF.** Line items: the chosen cut (Owner / Customer / Hiring) · 45-minute capture session · 1 hero cut (3–5 min) · 10 vertical shorts · 1 carousel · 1 article · 5 quote graphics · ad-use license. First 3 at $1,500 as a **case-study exchange** with the deliverable written in (never "discount"). Offered only after the guest's episode publishes.
- **The Next Stage cohort:** $250 refundable deposit (credited to tuition) · founding tuition $2,500 PIF or 3 × $950 · cohort 2 $3,500.
- **Sponsor seats:** not invoiced before the media kit exists (Q1 2027). Draft rates internal only.
- **Engine minimum term:** 4 months (June lock, ruled final by Brandon on Sept 22, 2026; System is 6 months. The 4-vs-6 question is closed).
- **Crucible work:** never scoped here. It is Kelly Bromley's.
...
- Authority Lite → RETIRED (2 legacy accounts bill at their grandfathered rate per contract; never scope new work at it)
- Authority Launchpad → $2,500 one-time (50% upfront)
- Guest Authority Package → $2,500 PIF (HLP guests only, after their episode publishes)
